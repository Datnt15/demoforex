...
*/
 ...
 $ACCESS_PWD='thongkhanh'; #!!!IMPORTANT!!! this is script access password, SET IT if you want to protect you DB from public access

 #DEFAULT db connection settings
 # --- WARNING! --- if you set defaults - it's recommended to set $ACCESS_PWD to protect your db!
 $DBDEF=array(
 'host'=>"localhost",#optional
 'user'=>"forex_user",#required
 'pwd'=>"forex_user123!@#", #required
 'db'=>"dh_forex",  #optional, default DB
 'port'=>"",#optional
